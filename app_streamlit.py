...
st.markdown("Klasifikasi level coding berdasarkan fitur hourse coding daily, preferred language, typing speed, import usage")

hours_coding_daily = st.slider("hours_coding_daily", 2.5, 5.5, 3.0)
preferred_language = st.pills("preferred_language", ["Python", "C++", "Java"])
